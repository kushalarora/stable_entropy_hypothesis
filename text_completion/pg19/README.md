...
```bash
sbatch -t 4:00:00 ./launcher_basic.sh python text_completion/pg19/generate_from_gpt2.py --model_name_or_path gpt2-xl --output_filename data/pg19_rankgen/generated/gpt2_xl/greedy.csv --fp16

sbatch -t 48:00:00 ./launcher_basic.sh python text_completion/pg19/generate_from_gpt2.py --model_name_or_path gpt2-xl --output_filename data/pg19_rankgen/generated/gpt2_xl/beam_5.csv --num_beams 5 --batch_size 4 --fp16
