...
def main():
    ...
    def tokenizer_function(examples):
        ...
        for context in examples['context']:
            contexts.append(f"A conversation between two persons.\n{context}")
    ...
    with open(args.output_filename, 'w') as output_file:
        for idx, batch_start in enumerate(range(0, len(dataset), args.batch_size)):
            ...
            generated_responses = tokenizer.batch_decode(generated_outputs,  skip_special_tokens=True)
