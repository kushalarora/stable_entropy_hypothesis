...
def main():
    ...
    wmt17_de_en_dataset = load_dataset("wmt17", "de-en")
    ...
    logger.info(args)
    wmt17_de_en_testset = wmt17_de_en_dataset['test']['translation']
    ...
    with open(args.output_filename, 'w') as output_file, \
        ...
        bleus = []
        for idx, batch_start in enumerate(range(0, len(wmt17_de_en_testset), args.batch_size)):
            batch, targets = tokenizer_method(wmt17_de_en_testset[batch_start: batch_start+args.batch_size])            
